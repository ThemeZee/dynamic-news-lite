...
class dynamicnews_Category_Posts_Columns_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array('classname' => 'dynamicnews_category_posts_columns', 'description' => __('Display latest posts from two specified categories. Please use this widget ONLY on Frontpage Magazine widget area.', 'dynamicnews') );
	...
	?>
		<div id="widget-category-posts-columns" class="widget-category-posts clearfix">
			...
			if ( $category_one > 0 && $category_two > 0 ) :
				...
				_e( 'Please specify two categories on the Category Posts Widget settings.', 'dynamicnews' );
	...
	?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('category_one'); ?>"><?php _e('Left Category:', 'dynamicnews'); ?><br/>
		...
		<p>
			<label for="<?php echo $this->get_field_id('category_two'); ?>"><?php _e('Right Category:', 'dynamicnews'); ?><br/>
