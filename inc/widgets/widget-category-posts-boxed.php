...
class dynamicnews_Category_Posts_Boxed_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array('classname' => 'dynamicnews_category_posts_boxed', 'description' => __('Display latest posts from category in boxed layout. Please use this widget ONLY on Frontpage Magazine widget area.', 'dynamicnews') );
